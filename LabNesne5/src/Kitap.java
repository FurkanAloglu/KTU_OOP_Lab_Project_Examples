...
public class Kitap implements OduncAlinabilir, Yazdirilabilir, Etiketli{
    ...
    public Kitap(){
        this("Bilinmeyen Kitap","Bilinmeyen Yazar",1);
    }

    public Kitap(String ad, String yazar, int sayi){
        if(ad == null || ad.isBlank()) throw new IllegalArgumentException("Kitap adı boş olamaz");
    ...
    public void oduncAl(String kime){
        ...
        if(this.sayi <= 0) throw new IllegalStateException("Kütüphanede mevcut kitap kalmadı");
        this.sayi--;
        this.oduncAlan = kime;
    }
    @Override
    ...
    @Override
    public String bilgi(){
        return "Kitap adı: " + ad + " | Yazar: " + yazar + " | Adet: " + sayi + (oduncAlan != null ? (" | Ödünç alan: "+oduncAlan) : "");
    }
    @Override
    public void yazdir(){
    ...
    public boolean equals(Object o){
        ...
        Kitap kitap = (Kitap) o;
        return Objects.equals(ad, kitap.ad) && Objects.equals(yazar, kitap.yazar);
    }
